                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group date-time-picker label-floating">
                                    ...
                                    <date-picker :date.sync="time" :formatStand.sync="newData.expense.time"></date-picker>
...
<script>
    ...
    export default {
        ...
        watch: {
            time() {
                this.newData.expense.time = this.newData.expense.time? this.newData.expense.time : this.time
            }
        },
