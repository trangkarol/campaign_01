<template>
    <div class="show-detail-image">
        <div class="mfp-wrap mfp-gallery mfp-close-btn-in mfp-zoom-in mfp-ready">
            <div class="mfp-container mfp-s-ready mfp-image-holder">
                ...
                <button :title="$t('user.sidebar.previous')"
                    @click="move('back')" v-if="showBack"
                    type="button"
                    class="mfp-arrow mfp-arrow-left mfp-prevent-close">
                </button>
                <button :title="$t('user.sidebar.next')"
                    @click="move('next')" v-if="showNext"
                    type="button"
